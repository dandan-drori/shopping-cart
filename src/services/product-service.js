const gProducts = [
	...
	},
	{
		...
		heading: 'Doggo',
		price: 49.9,
		imgUrl: 'https://static.archiesonline.com/public/images/product/large/89070890055602(D)_1.jpg',
	},
	{
		_id: 3,
		heading: 'Oh Deer',
	...
	},
	{
		...
		heading: 'Donkeyyy',
		price: 119.9,
		imgUrl: 'https://cdn.shopify.com/s/files/1/0012/3420/6827/products/4487_1200x.jpg?v=1536764622',
	},
	{
		_id: 6,
		heading: 'Sus',
...
function query(pageIdx) {
	...
	const endIdx = pageNum * 6
	return gProducts.slice(startIdx, endIdx)
}
